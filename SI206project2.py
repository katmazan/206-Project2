...
def grab_headlines():
    ...
    ##creating a list of all the strings creating the div tag of class item list
    words =  soup.findAll('div', attrs={'class':'item-list'})
    
    ##for loops going down into the larger string until reaching the titles
    for item in words[-1]:
        for thing in item:
            for layer2 in thing:
...
def get_umsi_data():
    ...
    for i in range(0,count):
        ...
        for name in names_lst:
            ...
            info[name] = title_lst[names_lst.index(name)]
